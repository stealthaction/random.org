...
class TestsMainPage:
    ...
    @allure.description(
        "Автотест проверяет вывод результата при вводе диапазона числа"
    )
    @pytest.mark.parametrize('min_number, max_number', [("1", "100"), ("1", "1"), ("23", "13")])
    def test_generate_number_in_range(self, main_page, min_number, max_number, context: BrowserContext):
