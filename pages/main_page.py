...
class MainPage:
    ...
    def fill_min_number(self, num: str) -> None:
        self.page.frame_locator(self.selectors.FRAME_LOCATOR).locator(
            self.selectors.INPUT_MIN_NUMBER
        ).fill(num)

    def fill_max_number(self, num: str) -> None:
        self.page.frame_locator(self.selectors.FRAME_LOCATOR).locator(
            self.selectors.INPUT_MAX_NUMBER
        ).fill(num)

    def click_button_generate(self) -> None:
        self.page.frame_locator(self.selectors.FRAME_LOCATOR).get_by_role(
    ...
    def assert_result(self, min: str, max: str) -> None:
        result = (
            self.page.frame_locator(self.selectors.FRAME_LOCATOR)
            .locator(self.selectors.GENERATING_NUM)
            .inner_text()
        )
        min_number = int(min)
        max_number = int(max)
        assert int(result) in range(
